...
TEST(search, find_first_of)
{
	...
	EXPECT_EQ(find_first_of(x, array<int>::values(3, 4, 3, 1)).idx(), 3);
	...
	EXPECT_EQ(find_first_of(y, array<int>::values(3, 4, 3, 1)).idx(), 3);
	...
	EXPECT_EQ(find_first_of(z, array<int>::values(3, 4, 3, 1)).idx(), 3);
...
TEST(search, find_last_of)
{
	...
	EXPECT_EQ(find_last_of(x, array<int>::values(3, 4, 3, 1)).idx(), 6);
	...
	EXPECT_EQ(find_last_of(y, array<int>::values(3, 4, 3, 1)).idx(), 6);
	...
	EXPECT_EQ(find_last_of(z, array<int>::values(3, 4, 3, 1)).idx(), 6);
...
{
	array<int> x = array<int>::values(10, 2, 8, 5, 3, 5, 7, 4, 2, 8, 5);
	EXPECT_EQ(find_first_pattern(x, array<int>::values(3, 2, 8, 5)).idx(), 0);
	EXPECT_EQ(find_first_pattern(x, array<int>::values(2, 8, 5)).idx(), 1);
	EXPECT_EQ(find_first_pattern(x, array<int>::values(1, 5)).idx(), 2);
	EXPECT_EQ(find_first_pattern(x, array<int>::values(3, 3, 5, 7)).idx(), 3);
	EXPECT_EQ(find_first_pattern(x, array<int>::values(3, 5, 7, 4)).idx(), 4);
	EXPECT_EQ(find_first_pattern(x, array<int>::values(4, 4, 2, 8, 5)).idx(), 6);
	...
	slice<range<array<int>::iterator> > y = x.sub();
	EXPECT_EQ(find_first_pattern(y, array<int>::values(3, 2, 8, 5)).idx(), 0);
	EXPECT_EQ(find_first_pattern(y, array<int>::values(2, 8, 5)).idx(), 1);
	EXPECT_EQ(find_first_pattern(y, array<int>::values(1, 5)).idx(), 2);
	EXPECT_EQ(find_first_pattern(y, array<int>::values(3, 3, 5, 7)).idx(), 3);
	EXPECT_EQ(find_first_pattern(y, array<int>::values(3, 5, 7, 4)).idx(), 4);
	EXPECT_EQ(find_first_pattern(y, array<int>::values(4, 4, 2, 8, 5)).idx(), 6);
	...
	const array<int> &z = x;
	EXPECT_EQ(find_first_pattern(z, array<int>::values(3, 2, 8, 5)).idx(), 0);
	EXPECT_EQ(find_first_pattern(z, array<int>::values(2, 8, 5)).idx(), 1);
	EXPECT_EQ(find_first_pattern(z, array<int>::values(1, 5)).idx(), 2);
	EXPECT_EQ(find_first_pattern(z, array<int>::values(3, 3, 5, 7)).idx(), 3);
	EXPECT_EQ(find_first_pattern(z, array<int>::values(3, 5, 7, 4)).idx(), 4);
	EXPECT_EQ(find_first_pattern(z, array<int>::values(4, 4, 2, 8, 5)).idx(), 6);
...
{
	array<int> x = array<int>::values(10, 2, 8, 5, 3, 5, 7, 4, 2, 8, 5);
	EXPECT_EQ(find_last_pattern(x, array<int>::values(3, 2, 8, 5)).idx(), 7);
	EXPECT_EQ(find_last_pattern(x, array<int>::values(2, 8, 5)).idx(), 8);
	EXPECT_EQ(find_last_pattern(x, array<int>::values(1, 5)).idx(), 9);
	EXPECT_EQ(find_last_pattern(x, array<int>::values(3, 3, 5, 7)).idx(), 3);
	EXPECT_EQ(find_last_pattern(x, array<int>::values(3, 5, 7, 4)).idx(), 4);
	EXPECT_EQ(find_last_pattern(x, array<int>::values(4, 4, 2, 8, 5)).idx(), 6);
	...
	slice<range<array<int>::iterator> > y = x.sub();
	EXPECT_EQ(find_last_pattern(y, array<int>::values(3, 2, 8, 5)).idx(), 7);
	EXPECT_EQ(find_last_pattern(y, array<int>::values(2, 8, 5)).idx(), 8);
	EXPECT_EQ(find_last_pattern(y, array<int>::values(1, 5)).idx(), 9);
	EXPECT_EQ(find_last_pattern(y, array<int>::values(3, 3, 5, 7)).idx(), 3);
	EXPECT_EQ(find_last_pattern(y, array<int>::values(3, 5, 7, 4)).idx(), 4);
	EXPECT_EQ(find_last_pattern(y, array<int>::values(4, 4, 2, 8, 5)).idx(), 6);
	...
	const array<int> &z = x;
	EXPECT_EQ(find_last_pattern(z, array<int>::values(3, 2, 8, 5)).idx(), 7);
	EXPECT_EQ(find_last_pattern(z, array<int>::values(2, 8, 5)).idx(), 8);
	EXPECT_EQ(find_last_pattern(z, array<int>::values(1, 5)).idx(), 9);
	EXPECT_EQ(find_last_pattern(z, array<int>::values(3, 3, 5, 7)).idx(), 3);
	EXPECT_EQ(find_last_pattern(z, array<int>::values(3, 5, 7, 4)).idx(), 4);
	EXPECT_EQ(find_last_pattern(z, array<int>::values(4, 4, 2, 8, 5)).idx(), 6);
...
TEST(search, find_all_pattern)
{
	array<int> x = array<int>::values(10, 2, 8, 5, 3, 5, 7, 4, 2, 8, 5);
	EXPECT_EQ(find_all_pattern(x, array<int>::values(3, 2, 8, 5)).idx(), array<int>::values(2, 0, 7));
	EXPECT_EQ(find_all_pattern(x, array<int>::values(2, 8, 5)).idx(), array<int>::values(2, 1, 8));
	EXPECT_EQ(find_all_pattern(x, array<int>::values(1, 5)).idx(), array<int>::values(3, 2, 4, 9));
	EXPECT_EQ(find_all_pattern(x, array<int>::values(3, 3, 5, 7)).idx(), array<int>::values(1, 3));
	EXPECT_EQ(find_all_pattern(x, array<int>::values(3, 5, 7, 4)).idx(), array<int>::values(1, 4));
	EXPECT_EQ(find_all_pattern(x, array<int>::values(4, 4, 2, 8, 5)).idx(), array<int>::values(1, 6));

	EXPECT_EQ(find_all_pattern(x, array<int>()).idx(), range<int>(0, 10));
	EXPECT_EQ(find_all_pattern(x, array<int>::values(1, 1)).idx(), array<int>());
	EXPECT_EQ(find_all_pattern(x, array<int>::values(3, 8, 5, 4)).idx(), array<int>());

	slice<range<array<int>::iterator> > y = x.sub();
	EXPECT_EQ(find_all_pattern(y, array<int>::values(3, 2, 8, 5)).idx(), array<int>::values(2, 0, 7));
	EXPECT_EQ(find_all_pattern(y, array<int>::values(2, 8, 5)).idx(), array<int>::values(2, 1, 8));
	EXPECT_EQ(find_all_pattern(y, array<int>::values(1, 5)).idx(), array<int>::values(3, 2, 4, 9));
	EXPECT_EQ(find_all_pattern(y, array<int>::values(3, 3, 5, 7)).idx(), array<int>::values(1, 3));
	EXPECT_EQ(find_all_pattern(y, array<int>::values(3, 5, 7, 4)).idx(), array<int>::values(1, 4));
	EXPECT_EQ(find_all_pattern(y, array<int>::values(4, 4, 2, 8, 5)).idx(), array<int>::values(1, 6));

	EXPECT_EQ(find_all_pattern(y, array<int>()).idx(), range<int>(0, 10));
	EXPECT_EQ(find_all_pattern(y, array<int>::values(1, 1)).idx(), array<int>());
	EXPECT_EQ(find_all_pattern(y, array<int>::values(3, 8, 5, 4)).idx(), array<int>());

	const array<int> &z = x;
	EXPECT_EQ(find_all_pattern(z, array<int>::values(3, 2, 8, 5)).idx(), array<int>::values(2, 0, 7));
	EXPECT_EQ(find_all_pattern(z, array<int>::values(2, 8, 5)).idx(), array<int>::values(2, 1, 8));
	EXPECT_EQ(find_all_pattern(z, array<int>::values(1, 5)).idx(), array<int>::values(3, 2, 4, 9));
	EXPECT_EQ(find_all_pattern(z, array<int>::values(3, 3, 5, 7)).idx(), array<int>::values(1, 3));
	EXPECT_EQ(find_all_pattern(z, array<int>::values(3, 5, 7, 4)).idx(), array<int>::values(1, 4));
	EXPECT_EQ(find_all_pattern(z, array<int>::values(4, 4, 2, 8, 5)).idx(), array<int>::values(1, 6));
...
{
	array<int> x = array<int>::values(12, 1, 2, 5, 6, 6, 8, 8, 10, 16, 29, 29, 29);
