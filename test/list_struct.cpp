...
{
	list<int> x(list<int>::values(5, 1, 9, 7, 2, 5));
	EXPECT_EQ(x, list<int>::values(5, 1, 9, 7, 2, 5));
}
...
{
	list<int> x = list<int>::values(5, 1, 3, 5, 7, 9);
	EXPECT_EQ(5, x.size());
	for (int i = 0; i < x.size(); i++)
		EXPECT_EQ(x[i], i*2+1);
}
...
{
	list<int> x = list<int>::values(8, 5, 2, 3, 5, 6, 2, 1, 7);
	list<int> y = list<int>::values(4, 3, 5, 6, 2);
	list<int> z = list<int>::values(4, 6, 2, 1, 7);
